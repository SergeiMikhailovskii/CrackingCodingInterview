...
class BinaryTree {
    ...
    fun countPathsWithSum(root: Node?, targetSum: Int): Int {
        if (root == null) {
            return 0
        }
    ...
    private fun countPathsWithSumFromNode(node: Node?, targetSum: Int, _currentSum: Int): Int {
...
fun main() {
    ...
    val value = tree.countPathsWithSum(tree.root, 3)
    println(value)
}